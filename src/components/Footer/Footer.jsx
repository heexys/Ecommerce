        ...
        <footer className="footer">
            <Container>
                <Row>
                    <Col lg='4' className='mb-4' md='6'>
                        <div className="logo">
                            ...
                            <p className="footer__text mt-4">
                                ...
                                Cumque
                                dolor labore enveniet vitae nulla itaque soluta sit
                                provident
                                consectur laboriosam?
                            </p>
                    </Col>

                    <Col lg='3' mb='3' className='mb-4'>
                    ...
                    <Col lg='12'>
                        <p className="footer__copyright">Copyright {year} developed by Heexys. All rights reserved.</p>
                    </Col>
                </Row>
            </Container>
        </footer>
